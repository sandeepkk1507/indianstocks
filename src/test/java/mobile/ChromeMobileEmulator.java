...
//		driver.findElement(By.xpath("//textarea[@placeholder='Write a caption…']")).sendKeys("Do you own any of these stocks? #midcap #nifty #trading #gain #top5 #money #stocks #stockmarket #nse #profit #financial #financialtrends");
...
//		Thread.sleep(5000);
//		driver.findElement(By.xpath("//button[text()='Next']")).click();
//		driver.findElement(By.xpath("//textarea[@placeholder='Write a caption…']")).sendKeys("Do you own any of these stocks? #nifty #largecap #nifty100 #trading #gain #top5 #money #stocks #stockmarket #nse #profit #financial #financialtrends");
//		driver.findElement(By.xpath("//img[@alt='Preview of photo to be uploaded']")).click();
//		driver.findElement(By.xpath("//button/span[text()='Add Location']")).click();
//		driver.findElement(By.xpath("//input[@placeholder='Find a location']")).click();
//		driver.findElement(By.xpath("//input[@placeholder='Find a location']")).sendKeys("nse");
...
//		Thread.sleep(5000);
//		driver.findElement(By.xpath("//button[text()='Next']")).click();
//		driver.findElement(By.xpath("//textarea[@placeholder='Write a caption…']")).sendKeys("#largecap #nifty #nifty100 #trading #gainloss #top5 #money #stocks #stockmarket #nse #loss #financial #financialtrends");
//		driver.findElement(By.xpath("//img[@alt='Preview of photo to be uploaded']")).click();
//		driver.findElement(By.xpath("//button/span[text()='Add Location']")).click();
//		driver.findElement(By.xpath("//input[@placeholder='Find a location']")).click();
//		driver.findElement(By.xpath("//input[@placeholder='Find a location']")).sendKeys("nse");
...
//		Thread.sleep(5000);
//		driver.findElement(By.xpath("//button[text()='Next']")).click();
//		driver.findElement(By.xpath("//textarea[@placeholder='Write a caption…']")).sendKeys("Do you own any of these stocks? #smallcap #nifty #trading #gain #top5 #money #stocks #stockmarket #nse #profit #financial #financialtrends");
//		driver.findElement(By.xpath("//img[@alt='Preview of photo to be uploaded']")).click();
//		driver.findElement(By.xpath("//button/span[text()='Add Location']")).click();
//		driver.findElement(By.xpath("//input[@placeholder='Find a location']")).click();
//		driver.findElement(By.xpath("//input[@placeholder='Find a location']")).sendKeys("nse");
